...
public class Gestacao implements EstadoDoProcesso{
    ...
    public void validar(Processo processo) {
        processo.estado = new Criado();
    }

    @Override
    public void designar(Processo processo) {
        throw new RuntimeException("Processo Em_Gestacao nao pode ser designado");
    }

    @Override
    public void cancelar(Processo processo) {
        throw new RuntimeException("Processo Em_Gestacao nao pode ser cancelado");
    }
    ...
    public void indeferir(Processo processo) {
        throw new RuntimeException("Processo Em_Gestacao nao pode ser indeferido");
    }

    @Override
    public void prazoLegal(Processo processo) {
        throw new RuntimeException("Processo Em_Gestacao nao pode ser prazo legal");
    }
}
